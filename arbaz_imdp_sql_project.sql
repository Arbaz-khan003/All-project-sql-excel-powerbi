...
QUESTION 3) Find the top two actors w]hose movies have a median rating>=8
answer 3)
...
Answer ) - Based on the comprehensive analysis of the movie dataset and considering Bolly Movies' objective to venture into the global market with their upcoming project, here are some recommendations for the types of content Bolly Movies should focus on producing:
 While Bollywood traditionally excels in romance and drama genres, it's essential for Bolly Movies to diversify its content offerings to appeal to a global audience. Exploring genres such as thriller, action, comedy, and science fiction can attract a broader audience base.
 Movies addressing socially relevant issues resonate well with global audiences. Bolly Movies should focus on producing content that tackles themes such as gender equality, mental health awareness, environmental conservation, and cultural diversity, ensuring authenticity and sensitivity in portrayal.
While appealing to global audiences, Bolly Movies should retain its cultural authenticity and identity. Integrating elements of Indian culture, traditions, and folklore into storytelling can provide a unique and enriching cinematic experience for international viewers.
